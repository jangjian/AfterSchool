...
int main(void)
{
	...
	sb.CARD.loadFromFile("./resources/sounds/card.ogg");

	Sound CARD_sound;
	CARD_sound.setBuffer(sb.CARD);
	CARD_sound.setVolume(100);
	...
	gameclear_sprite.setPosition((1200 - 640) / 2, (800 - 500) / 2);

	// gameover
	Sprite gameover_sprite;
	gameover_sprite.setTexture(t[10]);
	gameover_sprite.setPosition((1200-640)/2, (800-500)/2);
